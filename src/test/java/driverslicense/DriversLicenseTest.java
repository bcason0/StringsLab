...
public class DriversLicenseTest {
    ...
    public void deserializeToCSV(){
        ...
        driversLicenses = DriversLicense.deserializeToCSV(csvResult);
        String expectedName = "Mike Jones";
        String actualName = driversLicenses.get(0).getName();
        assertEquals("names should be equal", expectedName, actualName);
